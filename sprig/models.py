...
class Task(models.Model):
    ...
    expected_time = models.DurationField(verbose_name='予想時間', default=datetime.timedelta(hours=1))  # sprig デフォルト値
    actual_time = models.DurationField(verbose_name='実績時間', default=datetime.timedelta())  # sprig デフォルト値
    deadline = models.DateTimeField(verbose_name='納期', default=datetime.datetime.now() + datetime.timedelta(hours=1))  # sprig デフォルト値
    client = models.IntegerField(verbose_name='依頼者', default=0)  # sprig デフォルトは自分
